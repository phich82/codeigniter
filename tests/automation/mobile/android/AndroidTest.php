...
define("APK_APP_PATH", realpath(dirname(__FILE__).'/apps/ApiDemos-debug.apk'));
if (!APK_APP_PATH) { die("App did not exist!"); }

require_once('PHPUnit/Extensions/AppiumTestCase.php');
require_once('PHPUnit/Extensions/AppiumTestCase/Element.php');

class AndroidTest extends PHPUnit_Extensions_AppiumTestCase
{
    ...
    {
        $path = realpath(dirname(__FILE__).'/files/push/test_push_file.txt');
