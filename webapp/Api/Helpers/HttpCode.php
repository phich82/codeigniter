...
class HttpCode
{
    ...
    /**
     * Get the message by the http code
     *
     * @param string $httpCode
     * @return string
     */
    public static function message($httpCode = null)
    {
        return array_key_exists($httpCode, self::$http_status_codes) ? self::$http_status_codes[$httpCode] : '';
    }
}
